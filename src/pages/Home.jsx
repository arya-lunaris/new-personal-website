  ...
  return (
    <div className={`flex h-screen w-full relative font-[Fira Code] -mb-4 transition-colors duration-500 ${theme === 'dark' ? 'bg-[#121212]' : 'bg-white'}`}>
      ...
      <div className="flex-1 flex relative z-10 w-full -ml-20">
        {/* Headshot */}
        <div className={`-ml-15 sm:ml-0 md:ml-80 flex-1 h-12/12 transition-all duration-500 ease-out ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <img
            src={headshotSrc}
            alt="Arya headshot"
        ...
        {/* Right side */}
        <div className="flex-1 flex flex-col justify-center h-full -ml-10 sm:-ml-75 md:-ml-50">
